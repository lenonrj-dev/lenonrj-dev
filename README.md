...
### 💫 Sobre Mim
- 🌱 Desenvolvedor em constante evolução, com ênfase em **Front-end** e stack web moderna.  
- 🔭 Experiência prática com **Next.js, React, TypeScript, Tailwind, Node** e integrações REST/GraphQL.  
- ⚡ Interesses: **UI/UX**, **Core Web Vitals**, **SEO técnico**, automações e **Python**.  
- 💬 Curto desafios com foco em **qualidade**, **acessibilidade** e **performance**.
...
<td width="40%" align="right" valign="top">
  <img src="https://github.com/LenonCunha33/Lenon/blob/main/Laboratory.gif" alt="Laboratory GIF"
...
### 🧰 Tech & Tools
<p align="center">
  <img src="https://skillicons.dev/icons?i=nextjs,react,typescript,javascript,python,tailwind,nodejs,express" /><br/>
  <img src="https://skillicons.dev/icons?i=vite,vue,mongodb,prisma,git,github,figma,ubuntu" /><br/>
</p>
...
- **Front-end:** Next.js, React, TypeScript, Tailwind, animações (Framer Motion)  
- **Back-end:** Node.js/Express, APIs REST/GraphQL  
- **Dados:** MongoDB, Prisma  
- **Dev Experience:** Vite, Monorepos, Automação de build e DX  
- **Qualidade:** A11y, Core Web Vitals, SEO técnico

---

<p align="center">
  <sub>Obrigado por visitar! ⭐ Se curtir, considere deixar uma estrela em algum repositório — isso ajuda muito.</sub>
</p>
